...
**Python 2 vs Python 3** it's been a slow process, but it's just starting to feel like Python 2 really is the legacy version.  People use Python 3 for new projects.
